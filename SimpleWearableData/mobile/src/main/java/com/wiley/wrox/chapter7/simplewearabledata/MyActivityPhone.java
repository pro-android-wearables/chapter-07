/*
 * Copyright (C) 2014 A. Goransson, D. Cuartielles
 *
 * slightly modified code from an officila example
 * by the Android Open Source Project which responds to the license:
 ...
 * the paired wearable.
 */
public class MyActivityPhone extends Activity implements DataApi.DataListener,
        MessageApi.MessageListener, NodeApi.NodeListener, ConnectionCallbacks,
        OnConnectionFailedListener {

    private static final String TAG = "wrox";
